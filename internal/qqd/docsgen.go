...
| server_name | string or list | yes | Domain(s) for SNI and cert lookup. A list serves several hostnames from one certificate; the first entry is the cert directory name under <certs_dir>/live/, and every entry gets an HTTP-to-HTTPS redirect |
